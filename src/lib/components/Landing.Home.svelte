...
<div class="flex flex-row flex-wrap flex-grow px-16 py-32">
    ...
    <div class="flex-1 md:w-4/12 flex flex-col justify-between gap-16">
        <div class="text-primary font-semibold text-6xl leading-[1.25em]">
            Entrega <span class="text-accent">Veloz</span>
            y Fácil de <span class="text-accent">Encontrar</span>
        </div>
    ...
    <div class=" flex-1 lg:basis-0 basis-full p-4 flex flex-row items-center justify-center">
        <div
                class="relative aspect-square flex flex-row items-center justify-center"
                style="max-width: 500px"
        >
            <svg
                    class="absolute top-0 right-0 w-full aspect-square stroke-[3px] fill-none"
                    viewBox="0 0 100 100"
            ...
            >
                <path
                        d="
                M5,50
                A 45 45 0 0 1 20 16.5"
                        class="stroke-accent"
                />
                <path
                        d="
                M65,7.5
                A 45 45 0 0 1 94.7 55"
    ...
    <!--    Bullet Points-->
    <div class="md:pl-8 flex-1 md:w-3/12 flex flex-col justify-between">
